...
class IntegrationView {
	 ...
	 * @param array             $wpcf7_api_data    API configuration data
	 * @param array             $wpcf7_api_data_map Field mapping data
	 ...
	 * @param array             $mail_tags         Available mail tags
	 * @param array             $recent_logs       Recent API logs
	 * @param array             $statistics        API statistics
	 * @param array             $debug_info        Legacy debug information
	 * @return void
	 */
