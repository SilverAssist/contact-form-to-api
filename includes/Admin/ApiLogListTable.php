 ...
 * API Log List Table
 *
 * WordPress WP_List_Table implementation for displaying API logs.
...
/**
 * Class ApiLogListTable
 *
 * Displays API logs in WordPress admin using native WP_List_Table.
 *
 * @since 1.0.0
 */
class ApiLogListTable extends \WP_List_Table {
