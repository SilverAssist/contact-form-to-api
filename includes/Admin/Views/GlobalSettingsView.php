...
class GlobalSettingsView {
	...
	public static function render_page( Settings $settings, array $notices = array() ): void {
		...
		<div class="wrap cf7-api-settings-page">
			...
			<form method="post" action="<?php echo \esc_url( \admin_url( 'admin-post.php' ) ); ?>">
				...
				<?php self::render_email_alerts_section( $settings ); ?>
	 ...
	 * @return void
	 */
	private static function render_email_alerts_section( Settings $settings ): void {
		...
		<div class="cf7-api-section">
			<h2>
				...
				<?php \esc_html_e( 'Email Alerts', 'contact-form-to-api' ); ?>
			</h2>
			<p class="description">
				<?php \esc_html_e( 'Send alerts when API error rate exceeds thresholds', 'contact-form-to-api' ); ?>
			</p>
			...
			<table class="form-table" role="presentation">
				<tbody>
					<tr>
						<th scope="row">
							<?php \esc_html_e( 'Enable email alerts', 'contact-form-to-api' ); ?>
						</th>
						<td>
							<fieldset>
								<label>
					...
					<tr>
						...
						<td>
							<input type="text" 
								...
								class="regular-text"
								placeholder="<?php \esc_attr_e( 'admin@example.com, user@example.com', 'contact-form-to-api' ); ?>">
							<p class="description">
								<?php \esc_html_e( 'Comma-separated email addresses', 'contact-form-to-api' ); ?>
							</p>
						</td>
					</tr>
					<tr>
