...
namespace ContactFormToAPI\Tests\Helpers;
...
abstract class CF7TestCase extends TestCase
{
     ...
     */
    protected function createMockCF7Form(array $form_config = []): object
    {
        $default_config = [
            "id" => 123,
...
[submit "Send"]';
     ...
     */
    protected function createMockSubmissionData(array $override_data = []): array
    {
     ...
     */
    protected function createTestApiConfig(array $config_override = []): array
    {
        $default_config = [
            "enable_api" => true,
     ...
     */
    protected function mockSuccessfulApiResponse(array $response_data = []): array
    {
        $default_response = [
            "success" => true,
