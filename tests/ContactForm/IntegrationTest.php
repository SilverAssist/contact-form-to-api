...
namespace SilverAssist\ContactFormToAPI\Tests\ContactForm;
...
class IntegrationTest extends CF7TestCase {
	...
	public function testApiTimeoutConfiguration(): void {
		$config = $this->createTestApiConfig( array( 'timeout' => 60 ) );
	...
	public function testRetryMechanismConfiguration(): void {
		$config = $this->createTestApiConfig( array( 'retry_attempts' => 5 ) );
	...
	public function testDebugModeFeatures(): void {
		$config = $this->createTestApiConfig( array( 'debug_mode' => true ) );
