...
{ \"name\":\"[fullname]\", \"age\":30, \"car\":null }", $this->textdomain);
   ...
   * @return bool True if the value appears to be from a checkbox, false otherwise
   */
   ...
   * @return bool True if the value represents a checked checkbox, false otherwise
   */
